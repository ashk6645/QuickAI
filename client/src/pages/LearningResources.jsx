...
import { BookOpen, Search, Youtube, ExternalLink, GraduationCap, Loader2 } from "lucide-react";
                                ...
                                {resources.length === 0 ? (
                                    <div className="h-full flex flex-col justify-center items-center text-center py-16 opacity-50">
                                        ...
                                        <p className="text-muted-foreground max-w-xs">
                                            Paste a job description and click "Find Resources" to get curated learning materials for required skills.
                                        </p>
                                    </div>
                                ) : (
