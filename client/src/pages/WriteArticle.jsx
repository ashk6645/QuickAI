                ...
                {!content ? (
                  ...
                  <div className="px-4 py-3 prose prose-slate max-w-none dark:prose-invert">
                    <Markdown
                      ...
                      components={{
                        h1: ({ children }) => (
                          <h1 className="text-3xl font-bold text-foreground mb-6 mt-8 border-b border-border pb-3">
                            {children}
                          </h1>
                        ),
                        h2: ({ children }) => (
                        ...
                        p: ({ children }) => (
                          <p className="text-muted-foreground mb-4 leading-7 text-base">
                            {children}
                          </p>
                        ),
                        ul: ({ children }) => (
                          <ul className="list-disc ml-8 mb-4 space-y-2 text-muted-foreground">
                            {children}
                          </ul>
                        ),
                        ol: ({ children }) => (
                          <ol className="list-decimal ml-8 mb-4 space-y-2 text-muted-foreground">
                            {children}
                          </ol>
                        ),
                        li: ({ children }) => (
                        ...
                        blockquote: ({ children }) => (
                          <blockquote className="border-l-4 border-primary/50 pl-4 italic text-muted-foreground my-4 bg-secondary/30 py-2 rounded-r-lg">
                            {children}
                          </blockquote>
                        ),
                        code: ({ children }) => (
