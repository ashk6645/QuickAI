    ...
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        ...
        <div className='flex flex-wrap mt-10 justify-center'>
            {AiToolsData.map((tools, index)=>(
                <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border-gray-100 hover:-translaye-y-1 transition-all duration-300 cursor-pointer' onClick={() => user && navigate(tools.path)}>
