...
const Sidebar = ({sidebar, setSidebar}) => {
  ...
  return (
    <div className={`w-60 h-full bg-white border-r border-gray-200 flex flex-col max-sm:absolute top-0 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
